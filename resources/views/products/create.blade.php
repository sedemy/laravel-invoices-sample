                ...
                {!! Form::open(['url'=> route('products.store') ]) !!}
                        <div class="box-body">
                            ...
                            <div class="form-group {{$errors->has('product_desc') ? 'has-error' : '' }}">
                                {!! Form::label('product_desc','Some Description') !!}
                                {!! Form::text('product_desc',old('product_desc'),['class'=>"form-control" , 'placeholder'=>'Description' ]) !!}
                            </div>
                            <div class="form-group {{$errors->has('product_price') ? 'has-error' : '' }}">
                                {!! Form::label('product_price','Default Price') !!}
                                {!! Form::number('product_price',old('product_price'),['class'=>"form-control" , 'placeholder'=>'Price' ]) !!}
                            </div>
